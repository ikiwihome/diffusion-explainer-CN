...
d3.select("#latent-denoiser-l3-expl-text-container")
    .append("div")
    .text("(2) 以文本提示为条件的特定提示噪声.")
    .style("padding-bottom", "8px")
d3.select("#latent-denoiser-l3-expl-text-container")
    .append("div")
    .html('要生成与文本提示紧密贴合的图像，Stable Diffusion 会计算两个噪声的加权和，其权重由 <span style="font-weight:500"> guidance scale </span>控制。guidance scale越大，对文本提示的依从性就越强。')
